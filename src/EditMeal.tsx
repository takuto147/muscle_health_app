...
export const EditMeal = () => {
  ...
  const { meal, selectedDate } = location.state as {
    meal: Meal;
    selectedDate: string;
  };
  ...
  const handleMealNameChange = (e: ChangeEvent<HTMLInputElement>) =>
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <input
        type="text"
        className="rounded-lg border border-gray-200 text-gray-400"
      ...
      <button
        ...
        className="border-gray-200 shadow-md rounded-lg p-2  mt- active:translate-y-1 active:shadow-inner hover:bg-gray-300 bg-red-500 text-white"
      >
        削除
      </button>
    </div>
