...
export const Signin = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <br />
      <button className='border-gray-200 shadow-md rounded-lg p-3  active:translate-y-1 active:shadow-inner hover:bg-blue-300 mt-3' onClick={onSignin}>
        サインイン
      </button>
      <br />
      <br />
      <label className="text-sm font-semibold">アカウントが無い方はこちら</label>
      <br />
      <br />
      <Link to="/signup" className='border-gray-200 shadow-md rounded-lg p-3  active:translate-y-1 active:shadow-inner hover:bg-blue-300 mt-3'>新規作成</Link>
    </div>
  );
};
